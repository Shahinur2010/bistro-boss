            ...
            <form onSubmit={handleSubmit(onSubmit)}>
                ...
                <div className="flex">
                    ...
                    <div className="form-control w-full ml-4">
                        ...
                        <input type="number" placeholder="Price" {...register("price", { required: true })} className="input input-bordered w-full my-2" />
                    </div>
                </div>
                ...
                <div className="form-control w-full my-2">
                    ...
                    <input type="file" {...register("image", { required: true })} className="file-input file-input-bordered w-full my-2" />
                </div>
